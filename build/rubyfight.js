...
/* Generated by Opal 1.1.1 */
Opal.modules["rubyfight/version"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$, $$ = Opal.$$, $module = Opal.module;
  ...
  return (function($base, $parent_nesting) {
    ...
    Opal.const_set($nesting[0], 'VERSION', "0.0.1-opal")
  })($nesting[0], $nesting)
};

/* Generated by Opal 1.1.1 */
Opal.modules["rubyfight/game_config"] = function(Opal) {
  function $rb_times(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs * rhs : lhs['$*'](rhs);
  }
  function $rb_divide(lhs, rhs) {
...
/* Generated by Opal 1.1.1 */
Opal.modules["rubyfight/field_mask"] = function(Opal) {
  function $rb_ge(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs >= rhs : lhs['$>='](rhs);
  }
  var self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$, $$ = Opal.$$, $module = Opal.module, $truthy = Opal.truthy, $send = Opal.send;

  Opal.add_stubs(['$freeze', '$length', '$empty?', '$first', '$negative?', '$>=', '$[]', '$==', '$col_count', '$all?']);
  return (function($base, $parent_nesting) {
    var self = $module($base, 'Rubyfight');
    ...
    (function($base, $parent_nesting) {
      var self = $module($base, 'FieldMask');

      var $nesting = [self].concat($parent_nesting), $FieldMask_row_count$1, $FieldMask_col_count$2, $FieldMask_playable$ques$3, $FieldMask_rectangular$ques$4;

      
      Opal.const_set($nesting[0], 'ROWS', ["          000000000000          ", "         00000000000000         ", "       000000000000000000       ", "     0000000000000000000000     ", "   00000000000000000000000000   ", " 000000000000000000000000000000 ", "  0000000000000000000000000000  ", "   00000000000000000000000000   ", "    000000000000000000000000    ", "     0000000000000000000000     ", "      00000000000000000000      ", "       000000000000000000       ", "        0000000000000000        ", "         00000000000000         ", "          000000000000          ", "           0000000000           ", "            00000000            ", "             000000             "].$freeze());
      Opal.defs(self, '$row_count', $FieldMask_row_count$1 = function $$row_count() {
        var self = this;

        return $$($nesting, 'ROWS').$length()
      }, $FieldMask_row_count$1.$$arity = 0);
      Opal.defs(self, '$col_count', $FieldMask_col_count$2 = function $$col_count() {
        var self = this;

        
        if ($truthy($$($nesting, 'ROWS')['$empty?']())) {
          return 0};
        return $$($nesting, 'ROWS').$first().$length();
      }, $FieldMask_col_count$2.$$arity = 0);
      Opal.defs(self, '$playable?', $FieldMask_playable$ques$3 = function(row, col) {
        var self = this, $ret_or_1 = nil, $ret_or_2 = nil;

        
        if ($truthy((function() {if ($truthy(($ret_or_1 = row['$negative?']()))) {
          return $ret_or_1
        } else {
          return $rb_ge(row, $$($nesting, 'ROWS').$length())
        }; return nil; })())) {
          return false};
        if ($truthy((function() {if ($truthy(($ret_or_2 = col['$negative?']()))) {
          return $ret_or_2
        } else {
          return $rb_ge(col, $$($nesting, 'ROWS')['$[]'](row).$length())
        }; return nil; })())) {
          return false};
        return $$($nesting, 'ROWS')['$[]'](row)['$[]'](col)['$==']("0");
      }, $FieldMask_playable$ques$3.$$arity = 2);
      Opal.defs(self, '$rectangular?', $FieldMask_rectangular$ques$4 = function() {
        var $$5, self = this, w = nil;

        
        w = self.$col_count();
        return $send($$($nesting, 'ROWS'), 'all?', [], ($$5 = function(r){var self = $$5.$$s == null ? this : $$5.$$s;
          ...
          return r.$length()['$=='](w);}, $$5.$$s = self, $$5.$$arity = 1, $$5));
      }, $FieldMask_rectangular$ques$4.$$arity = 0);
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
...
/* Generated by Opal 1.1.1 */
Opal.modules["rubyfight/territory"] = function(Opal) {
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  }
  function $rb_times(lhs, rhs) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      Opal.defs(self, '$empty_grid', $Territory_empty_grid$1 = function $$empty_grid(rows, cols) {
        ...
        return $send($$($nesting, 'Array'), 'new', [rows], ($$2 = function(){var self = $$2.$$s == null ? this : $$2.$$s;

        return $$($nesting, 'Array').$new(cols, 0)}, $$2.$$s = self, $$2.$$arity = 0, $$2))
      }, $Territory_empty_grid$1.$$arity = 2);
      Opal.defs(self, '$point_in_triangle?', $Territory_point_in_triangle$ques$3 = function(px, py, x0, y0, x1, y1, x2, y2) {
        var self = this, d = nil, $ret_or_1 = nil, $ret_or_2 = nil, $ret_or_3 = nil, $ret_or_4 = nil, $ret_or_5 = nil, a = nil, b = nil, c = nil, eps = nil, $ret_or_6 = nil, $ret_or_7 = nil;

        
        d = $rb_plus($rb_times($rb_minus(y1, y2), $rb_minus(x0, x2)), $rb_times($rb_minus(x2, x1), $rb_minus(y0, y2)));
        if (d['$=='](0)) {
          return (function() {if ($truthy(($ret_or_1 = (function() {if ($truthy(($ret_or_2 = (function() {if ($truthy(($ret_or_3 = px['$=='](x0)))) {
            return py['$=='](y0)
          } else {
            return $ret_or_3
          }; return nil; })()))) {
        ...
        d = d.$to_f();
        a = $rb_divide($rb_plus($rb_times($rb_minus(y1, y2), $rb_minus(px, x2)), $rb_times($rb_minus(x2, x1), $rb_minus(py, y2))), d);
        b = $rb_divide($rb_plus($rb_times($rb_minus(y2, y0), $rb_minus(px, x2)), $rb_times($rb_minus(x0, x2), $rb_minus(py, y2))), d);
        c = $rb_minus($rb_minus(1.0, a), b);
        eps = -0.01;
        if ($truthy(($ret_or_6 = (function() {if ($truthy(($ret_or_7 = $rb_ge(a, eps)))) {
          return $rb_ge(b, eps)
        } else {
          return $ret_or_7
        }; return nil; })()))) {
      ...
      }, $Territory_point_in_triangle$ques$3.$$arity = 8);
      Opal.defs(self, '$fill_triangle!', $Territory_fill_triangle$excl$4 = function(grid, player_id, flags, mask_rows) {
        var $a, $b, $$5, self = this, p0 = nil, p1 = nil, p2 = nil, x0 = nil, y0 = nil, x1 = nil, y1 = nil, x2 = nil, y2 = nil, min_x = nil, max_x = nil, min_y = nil, max_y = nil, filled = nil;

        
        if ($truthy(flags.$length()['$!='](3))) {
          return 0};
        $b = flags, $a = Opal.to_ary($b), (p0 = ($a[0] == null ? nil : $a[0])), (p1 = ($a[1] == null ? nil : $a[1])), (p2 = ($a[2] == null ? nil : $a[2])), $b;
        $b = p0, $a = Opal.to_ary($b), (x0 = ($a[0] == null ? nil : $a[0])), (y0 = ($a[1] == null ? nil : $a[1])), $b;
        $b = p1, $a = Opal.to_ary($b), (x1 = ($a[0] == null ? nil : $a[0])), (y1 = ($a[1] == null ? nil : $a[1])), $b;
        $b = p2, $a = Opal.to_ary($b), (x2 = ($a[0] == null ? nil : $a[0])), (y2 = ($a[1] == null ? nil : $a[1])), $b;
        min_x = [x0, x1, x2].$min();
        max_x = [x0, x1, x2].$max();
        min_y = [y0, y1, y2].$min();
        max_y = [y0, y1, y2].$max();
        filled = 0;
        $send(Opal.Range.$new(min_y, max_y, false), 'each', [], ($$5 = function(y){var self = $$5.$$s == null ? this : $$5.$$s, $$6;
          ...
          return $send(Opal.Range.$new(min_x, max_x, false), 'each', [], ($$6 = function(x){var self = $$6.$$s == null ? this : $$6.$$s, $ret_or_8 = nil, $writer = nil;
            ...
            if ($truthy((function() {if ($truthy(($ret_or_8 = mask_rows['$[]'](y)['$nil?']()))) {
              return $ret_or_8
            } else {
              return mask_rows['$[]'](y)['$[]'](x)['$=='](" ")
            }; return nil; })())) {
              return nil;};
            if ($truthy(self['$point_in_triangle?'](x, y, x0, y0, x1, y1, x2, y2))) {
            } else {
              return nil;
            };
            if ($truthy(grid['$[]'](y)['$[]'](x)['$!='](player_id))) {
              
              
              $writer = [x, player_id];
              $send(grid['$[]'](y), '[]=', Opal.to_a($writer));
              $writer[$rb_minus($writer["length"], 1)];;
              return (filled = $rb_plus(filled, 1));
            } else {
              return nil
            };}, $$6.$$s = self, $$6.$$arity = 1, $$6));}, $$5.$$s = self, $$5.$$arity = 1, $$5));
        return filled;
      }, $Territory_fill_triangle$excl$4.$$arity = 4);
      Opal.defs(self, '$calc_scores', $Territory_calc_scores$7 = function $$calc_scores(grid, mask_rows) {
        var $$8, self = this, p1 = nil, p2 = nil;

        
        p1 = 0;
        p2 = 0;
        $send(grid, 'each_with_index', [], ($$8 = function(row, y){var self = $$8.$$s == null ? this : $$8.$$s, $$9;
          ...
          return $send(row, 'each_with_index', [], ($$9 = function(cell, x){var self = $$9.$$s == null ? this : $$9.$$s, $ret_or_9 = nil;
            ...
            if (cell['$=='](1)) {
              p1 = $rb_plus(p1, 1)};
            if (cell['$=='](2)) {
              return (p2 = $rb_plus(p2, 1))
            } else {
              return nil
            };}, $$9.$$s = self, $$9.$$arity = 2, $$9));}, $$8.$$s = self, $$8.$$arity = 2, $$8));
        return [p1, p2];
      }, $Territory_calc_scores$7.$$arity = 2);
      Opal.defs(self, '$push_flag', $Territory_push_flag$10 = function $$push_flag(flags, gx, gy) {
        var $$11, self = this;
      ...
      Opal.defs(self, '$pick_target_center', $Cpu_pick_target_center$4 = function $$pick_target_center(grid, mask_rows, $a, $b) {
        ...
        $send(rows, 'times', [], ($$5 = function(y){var self = $$5.$$s == null ? this : $$5.$$s, $$6;
          ...
          return $send(cols, 'times', [], ($$6 = function(x){var self = $$6.$$s == null ? this : $$6.$$s, $$7, cx = nil, cy = nil, c = nil, p1n = nil, p0n = nil, d = nil, cbonus = nil, h = nil, tri = nil, gain = nil, fx = nil, fy = nil, span = nil, s = nil;
            ...
            if (grid['$[]'](y)['$[]'](x)['$=='](2)) {
              return nil;};
            cx = $rb_plus($rb_times(x, tile), $rb_divide(tile, 2.0));
            cy = $rb_plus($rb_times(y, tile), $rb_divide(tile, 2.0));
            if ($truthy($$($nesting, 'Layout')['$player_position_valid?'](cx, cy, mask_rows))) {
            } else {
              return nil;
            };
            c = grid['$[]'](y)['$[]'](x);
...
/* Generated by Opal 1.1.1 */
Opal.modules["rubyfight/graphics"] = function(Opal) {
  function $rb_le(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs <= rhs : lhs['$<='](rhs);
  }
  function $rb_divide(lhs, rhs) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      Opal.defs(self, '$clamp', $Graphics_clamp$1 = function $$clamp(val, min_v, max_v) {
        ...
        return [[val, min_v].$max(), max_v].$min()
      }, $Graphics_clamp$1.$$arity = 3);
      Opal.defs(self, '$blink_even_phase?', $Graphics_blink_even_phase$ques$2 = function(now_ms, period_ms) {
        var self = this;

        
        if ($truthy($rb_le(period_ms, 0))) {
          return false};
        return $rb_divide(now_ms.$to_f(), period_ms).$floor()['$%'](2)['$=='](0);
      }, $Graphics_blink_even_phase$ques$2.$$arity = 2);
      Opal.defs(self, '$asset_sheet_cell_pair', $Graphics_asset_sheet_cell_pair$3 = function $$asset_sheet_cell_pair(name) {
        var self = this, sheet = nil, cells = nil, nm = nil, c = nil;

        
        sheet = $$($nesting, 'GameConfig').$to_browser_hash()['$[]']("ASSET_SHEET");
        cells = sheet['$[]']("cells");
        nm = name.$to_s();
        c = cells['$[]'](nm);
        if ($truthy(c['$nil?']())) {
      ...
      Opal.defs(self, '$title_char_frame_index', $Graphics_title_char_frame_index$8 = function $$title_char_frame_index(now_ms, fps, frame_start, frame_count, cols, rows) {
        ...
        total = $rb_times(cols, rows);
        tick = $rb_divide(now_ms.$to_f(), $rb_divide(1000.0, fps)).$floor();
      ...
      Opal.defs(self, '$clamp_sheet_source', $Graphics_clamp_sheet_source$10 = function $$clamp_sheet_source(iw, ih, sx, sy, sw, sh) {
        ...
        if ($truthy($rb_lt(y, 0))) {
          ...
          h = $rb_plus(h, y);
          y = 0;};
        if ($truthy($rb_gt($rb_plus(x, w), iw))) {
          w = $rb_minus(iw, x)};
      ...
      Opal.defs(self, '$sheet_cell_rect', $Graphics_sheet_cell_rect$12 = function $$sheet_cell_rect(gx, gy, gw, gh, cols, rows, col, row, cell_inset) {
        ...
        cw = $rb_divide(gw.$to_f(), cols).$floor();
        ch = $rb_divide(gh.$to_f(), rows).$floor();
        sx = $rb_plus(gx, $rb_times(col, cw));
        sy = $rb_plus(gy, $rb_times(row, ch));
        sw = (function() {if (col['$==']($rb_minus(cols, 1))) {
          return $rb_minus($rb_plus(gx, gw), sx)
        } else {
          return cw
        }; return nil; })();
        sh = (function() {if (row['$==']($rb_minus(rows, 1))) {
          return $rb_minus($rb_plus(gy, gh), sy)
        } else {
          return ch
        }; return nil; })();
        ins = cell_inset.$to_i();
        if ($truthy($rb_gt(ins, 0))) {
...
/* Generated by Opal 1.1.1 */
Opal.modules["rubyfight/game_state"] = function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  function $rb_le(lhs, rhs) {
  ...
  Opal.add_stubs(['$require', '$-', '$<=', '$>', '$blink_even_phase?', '$%', '$+', '$===']);
  
  self.$require("rubyfight/graphics");
  return (function($base, $parent_nesting) {
    var self = $module($base, 'Rubyfight');
    ...
    (function($base, $parent_nesting) {
      var self = $module($base, 'GameState');

      var $nesting = [self].concat($parent_nesting), $GameState_tick_playing$1, $GameState_can_advance_from_result$ques$2, $GameState_blink_500ms_primary$ques$3, $GameState_menu_prev_index$4, $GameState_menu_next_index$5, $GameState_title_confirm_action$6;

      
      Opal.const_set($nesting[0], 'TITLE', "TITLE");
      Opal.const_set($nesting[0], 'PLAYING', "PLAYING");
      Opal.const_set($nesting[0], 'RESULT', "RESULT");
      Opal.const_set($nesting[0], 'COOLDOWN_MS_BEFORE_RESULT_ADVANCE', 2000);
      Opal.defs(self, '$tick_playing', $GameState_tick_playing$1 = function $$tick_playing(time_remaining, delta) {
        var self = this, next_remaining = nil;

        
        next_remaining = $rb_minus(time_remaining, delta);
        if ($truthy($rb_le(next_remaining, 0))) {
          return [0.0, $$($nesting, 'RESULT')]
        } else {
          return [next_remaining, nil]
        };
      }, $GameState_tick_playing$1.$$arity = 2);
      Opal.defs(self, '$can_advance_from_result?', $GameState_can_advance_from_result$ques$2 = function(now_ms, state_started_ms) {
        var self = this;

        return $rb_gt($rb_minus(now_ms, state_started_ms), $$($nesting, 'COOLDOWN_MS_BEFORE_RESULT_ADVANCE'))
      }, $GameState_can_advance_from_result$ques$2.$$arity = 2);
      Opal.defs(self, '$blink_500ms_primary?', $GameState_blink_500ms_primary$ques$3 = function(now_ms) {
        var self = this;

        return $$($nesting, 'Graphics')['$blink_even_phase?'](now_ms, 500)
      }, $GameState_blink_500ms_primary$ques$3.$$arity = 1);
      Opal.defs(self, '$menu_prev_index', $GameState_menu_prev_index$4 = function $$menu_prev_index(index, menu_size) {
        var self = this;

        return $rb_minus($rb_plus(index, menu_size), 1)['$%'](menu_size)
      }, $GameState_menu_prev_index$4.$$arity = 2);
      Opal.defs(self, '$menu_next_index', $GameState_menu_next_index$5 = function $$menu_next_index(index, menu_size) {
        var self = this;

        return $rb_plus(index, 1)['$%'](menu_size)
      }, $GameState_menu_next_index$5.$$arity = 2);
      Opal.defs(self, '$title_confirm_action', $GameState_title_confirm_action$6 = function $$title_confirm_action(menu_index) {
        var self = this, $case = nil;

        return (function() {$case = menu_index;
        if ((0)['$===']($case)) {return "vs_cpu"}
        else if ((1)['$===']($case)) {return "vs_2p"}
        else { return nil }})()
      }, $GameState_title_confirm_action$6.$$arity = 1);
    })($nesting[0], $nesting)
  })($nesting[0], $nesting);
};

/* Generated by Opal 1.1.1 */
Opal.modules["rubyfight/movement"] = function(Opal) {
  function $rb_le(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs <= rhs : lhs['$<='](rhs);
  }
  function $rb_times(lhs, rhs) {
  ...
  var self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$, $$ = Opal.$$, $module = Opal.module, $truthy = Opal.truthy, $hash2 = Opal.hash2;

  Opal.add_stubs(['$require', '$to_browser_hash', '$to_f', '$[]', '$<=', '$*', '$speed_for_time_remaining', '$<', '$/', '$+', '$-', '$>', '$blink_even_phase?']);
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      var self = $module($base, 'Movement');

      var $nesting = [self].concat($parent_nesting), $Movement_speed_for_time_remaining$1, $Movement_cpu_speed_for_time_remaining$2, $Movement_cpu_reached_target$ques$3, $Movement_nudge_toward_field_center$4, $Movement_rush_hud_blink_primary$ques$5;
      ...
      Opal.defs(self, '$speed_for_time_remaining', $Movement_speed_for_time_remaining$1 = function $$speed_for_time_remaining(time_remaining) {
        ...
        c = $$($nesting, 'GameConfig').$to_browser_hash();
        rush = c['$[]']("RUSH_TIME").$to_f();
        base = c['$[]']("BASE_SPEED").$to_f();
        mult = c['$[]']("SPEED_UP_MULTIPLIER").$to_f();
        if ($truthy($rb_le(time_remaining, rush))) {
          return $rb_times(base, mult)
        } else {
          return base
        };
      }, $Movement_speed_for_time_remaining$1.$$arity = 1);
      Opal.defs(self, '$cpu_speed_for_time_remaining', $Movement_cpu_speed_for_time_remaining$2 = function $$cpu_speed_for_time_remaining(time_remaining) {
        var self = this, cpu_mult = nil;

        
        cpu_mult = $$($nesting, 'GameConfig').$to_browser_hash()['$[]']("CPU_SPEED_MULTIPLIER").$to_f();
        return $rb_times(self.$speed_for_time_remaining(time_remaining), cpu_mult);
      }, $Movement_cpu_speed_for_time_remaining$2.$$arity = 1);
      Opal.defs(self, '$cpu_reached_target?', $Movement_cpu_reached_target$ques$3 = function(dist, cpu_speed, delta, $kwargs) {
        var epsilon, self = this, $ret_or_1 = nil;
        ...
        epsilon = $kwargs.$$smap["epsilon"];
        if (epsilon == null) {
          epsilon = $$($nesting, 'ARRIVAL_EPSILON_PX')
        };
        if ($truthy(($ret_or_1 = $rb_lt(dist, $rb_times(cpu_speed, delta))))) {
          return $ret_or_1
        } else {
          return $rb_lt(dist, epsilon)
        };
      }, $Movement_cpu_reached_target$ques$3.$$arity = -4);
      Opal.defs(self, '$nudge_toward_field_center', $Movement_nudge_toward_field_center$4 = function $$nudge_toward_field_center(px, py, $kwargs) {
        var factor, self = this, c = nil, fw = nil, fh = nil, cx = nil, cy = nil;
        ...
        factor = $kwargs.$$smap["factor"];
        if (factor == null) {
          factor = $$($nesting, 'NUDGE_CENTER_FACTOR')
        };
        c = $$($nesting, 'GameConfig').$to_browser_hash();
        ...
        cx = $rb_divide(fw, 2.0);
        cy = $rb_divide(fh, 2.0);
        return [$rb_plus(px, $rb_times($rb_minus(cx, px), factor)), $rb_plus(py, $rb_times($rb_minus(cy, py), factor))];
      }, $Movement_nudge_toward_field_center$4.$$arity = -3);
      Opal.defs(self, '$rush_hud_blink_primary?', $Movement_rush_hud_blink_primary$ques$5 = function(time_remaining, now_ms) {
        var self = this, c = nil;

        
        c = $$($nesting, 'GameConfig').$to_browser_hash();
        if ($truthy($rb_gt(time_remaining, c['$[]']("RUSH_TIME").$to_f()))) {
          return false};
        return $$($nesting, 'Graphics')['$blink_even_phase?'](now_ms, 100);
      }, $Movement_rush_hud_blink_primary$ques$5.$$arity = 2);
    })($nesting[0], $nesting)
  })($nesting[0], $nesting);
};

/* Generated by Opal 1.1.1 */
Opal.modules["rubyfight/match"] = function(Opal) {
  function $rb_gt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs > rhs : lhs['$>'](rhs);
  }
  var self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$, $$ = Opal.$$, $module = Opal.module, $truthy = Opal.truthy;
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      var self = $module($base, 'Match');

      var $nesting = [self].concat($parent_nesting), $Match_result_headline$1, $Match_result_tone$2;

      
      Opal.defs(self, '$result_headline', $Match_result_headline$1 = function $$result_headline(p1_score, p2_score, vs_cpu) {
        var self = this;

        if ($truthy($rb_gt(p1_score, p2_score))) {
          return "P1 WINS!"
        } else if ($truthy($rb_gt(p2_score, p1_score))) {
          if ($truthy(vs_cpu)) {
            return "CPU WINS!"
          } else {
            return "P2 WINS!"
      ...
      }, $Match_result_headline$1.$$arity = 3);
      Opal.defs(self, '$result_tone', $Match_result_tone$2 = function $$result_tone(p1_score, p2_score) {
        var self = this;
      ...
      }, $Match_result_tone$2.$$arity = 2);
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};

/* Generated by Opal 1.1.1 */
Opal.modules["rubyfight/session"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$, $$ = Opal.$$, $module = Opal.module;

  Opal.add_stubs(['$require', '$to_f', '$[]', '$to_browser_hash', '$default_spawn', '$grid_rows', '$grid_cols', '$empty_grid']);
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      var self = $module($base, 'Session');

      var $nesting = [self].concat($parent_nesting), $Session_initial_time_remaining$1, $Session_p1_spawn_xy$2, $Session_p2_spawn_xy$3, $Session_ruby_empty_grid_pair$4;

      
      Opal.defs(self, '$initial_time_remaining', $Session_initial_time_remaining$1 = function $$initial_time_remaining() {
        var self = this;

        return $$($nesting, 'GameConfig').$to_browser_hash()['$[]']("GAME_TIME").$to_f()
      }, $Session_initial_time_remaining$1.$$arity = 0);
      Opal.defs(self, '$p1_spawn_xy', $Session_p1_spawn_xy$2 = function $$p1_spawn_xy() {
        var self = this;

        return $$($nesting, 'Layout').$default_spawn("p1")
      }, $Session_p1_spawn_xy$2.$$arity = 0);
      Opal.defs(self, '$p2_spawn_xy', $Session_p2_spawn_xy$3 = function $$p2_spawn_xy() {
        var self = this;

        return $$($nesting, 'Layout').$default_spawn("p2")
      }, $Session_p2_spawn_xy$3.$$arity = 0);
      Opal.defs(self, '$ruby_empty_grid_pair', $Session_ruby_empty_grid_pair$4 = function $$ruby_empty_grid_pair() {
        var self = this, rows = nil, cols = nil, a = nil, b = nil;

        
        rows = $$($nesting, 'Layout').$grid_rows();
        cols = $$($nesting, 'Layout').$grid_cols();
        a = $$($nesting, 'Territory').$empty_grid(rows, cols);
        b = $$($nesting, 'Territory').$empty_grid(rows, cols);
        return [a, b];
      }, $Session_ruby_empty_grid_pair$4.$$arity = 0);
    })($nesting[0], $nesting)
  })($nesting[0], $nesting);
};

/* Generated by Opal 1.1.1 */
Opal.modules["rubyfight/ui_layout"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $$$ = Opal.$$$, $$ = Opal.$$, $module = Opal.module, $hash2 = Opal.hash2;
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      var self = $module($base, 'UiLayout');

      var $nesting = [self].concat($parent_nesting), $UiLayout_to_browser_hash$1;

      Opal.defs(self, '$to_browser_hash', $UiLayout_to_browser_hash$1 = function $$to_browser_hash() {
        var self = this;

        return $hash2(["title"], {"title": $hash2(["logoCenterX", "juggingY", "mainTitleY", "subRubykaigiY", "subTerritoryY", "menu", "mascotLeft", "mascotRight", "mascotPixel", "footerControlsY", "footerFullscreenY", "parts"], {"logoCenterX": 480, "juggingY": 44, "mainTitleY": 126, "subRubykaigiY": 192, "subTerritoryY": 216, "menu": $hash2(["y"], {"y": 292}), "mascotLeft": $hash2(["x", "y"], {"x": 124, "y": 306}), "mascotRight": $hash2(["x", "y"], {"x": 836, "y": 306}), "mascotPixel": 3, "footerControlsY": 458, "footerFullscreenY": 478, "parts": $hash2(["background", "logo", "charLeft", "charRight"], {"background": $hash2(["x", "y", "w", "h", "fit"], {"x": 0, "y": 0, "w": 960, "h": 540, "fit": "cover"}), "logo": $hash2(["x", "y", "w", "h", "fit"], {"x": 136, "y": 32, "w": 688, "h": 252, "fit": "contain"}), "charLeft": $hash2(["x", "y", "w", "h", "fit", "vAlign"], {"x": 70, "y": 230, "w": 208, "h": 224, "fit": "contain", "vAlign": "bottom"}), "charRight": $hash2(["x", "y", "w", "h", "fit", "vAlign"], {"x": 682, "y": 230, "w": 208, "h": 224, "fit": "contain", "vAlign": "bottom"})})})})
...
(function(Opal) {
  ...
  self.$require("rubyfight/territory");
  self.$require("rubyfight/cpu");
  self.$require("rubyfight/game_state");
  self.$require("rubyfight/movement");
  self.$require("rubyfight/match");
  self.$require("rubyfight/session");
  self.$require("rubyfight/graphics");
  self.$require("rubyfight/ui_layout");
  (function($base, $parent_nesting) {
    var self = $module($base, 'Rubyfight');

    var $nesting = [self].concat($parent_nesting), $Rubyfight_boot_banner$1, $Rubyfight_announce$excl$2, $Rubyfight_expose_to_browser$excl$3, $Rubyfight_attach_territory_bridge$excl$4, $Rubyfight_attach_layout_bridge$excl$5, $Rubyfight_attach_cpu_bridge$excl$6, $Rubyfight_attach_graphics_bridge$excl$7, $Rubyfight_attach_match_bridge$excl$8, $Rubyfight_attach_session_bridge$excl$9, $Rubyfight_attach_movement_bridge$excl$10, $Rubyfight_attach_game_state_bridge$excl$11;

    
    Opal.defs(self, '$boot_banner', $Rubyfight_boot_banner$1 = function $$boot_banner() {
      var self = this;

      return "" + "[RUBYFIGHT] Ruby core " + ($$($nesting, 'VERSION')) + " (Opal)"
    }, $Rubyfight_boot_banner$1.$$arity = 0);
    Opal.defs(self, '$announce!', $Rubyfight_announce$excl$2 = function() {
      var self = this;

      return self.$puts(self.$boot_banner())
    }, $Rubyfight_announce$excl$2.$$arity = 0);
    Opal.defs(self, '$expose_to_browser!', $Rubyfight_expose_to_browser$excl$3 = function() {
      var self = this, j = nil, r = nil, u = nil;

      
      j = $$($nesting, 'JSON').$dump($$($nesting, 'GameConfig').$to_browser_hash());
      r = $$($nesting, 'JSON').$dump($$$($$($nesting, 'FieldMask'), 'ROWS'));
      u = $$($nesting, 'JSON').$dump($$($nesting, 'UiLayout').$to_browser_hash());
    ...
    Opal.defs(self, '$attach_cpu_bridge!', $Rubyfight_attach_cpu_bridge$excl$6 = function() {
      var self = this, c = nil;
    ...
    Opal.defs(self, '$attach_graphics_bridge!', $Rubyfight_attach_graphics_bridge$excl$7 = function() {
      var self = this, gfx = nil;

      
      gfx = $$($nesting, 'Graphics');
    ...
    Opal.defs(self, '$attach_match_bridge!', $Rubyfight_attach_match_bridge$excl$8 = function() {
      var self = this, mt = nil;
    ...
    Opal.defs(self, '$attach_movement_bridge!', $Rubyfight_attach_movement_bridge$excl$10 = function() {
      var self = this, m = nil;
    ...
    Opal.defs(self, '$attach_game_state_bridge!', $Rubyfight_attach_game_state_bridge$excl$11 = function() {
      var self = this, g = nil;
  ...
  $$($nesting, 'Rubyfight')['$attach_cpu_bridge!']();
  $$($nesting, 'Rubyfight')['$attach_movement_bridge!']();
  $$($nesting, 'Rubyfight')['$attach_match_bridge!']();
  $$($nesting, 'Rubyfight')['$attach_session_bridge!']();
  $$($nesting, 'Rubyfight')['$attach_graphics_bridge!']();
  $$($nesting, 'Rubyfight')['$attach_game_state_bridge!']();
