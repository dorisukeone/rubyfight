...
Opal.modules["rubyfight/cpu"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      var $nesting = [self].concat($parent_nesting), $Cpu_pick_target_center$1;
...
Opal.modules["rubyfight/game_state"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      var $nesting = [self].concat($parent_nesting), $GameState_tick_playing$1, $GameState_can_advance_from_result$ques$2, $GameState_menu_prev_index$3, $GameState_menu_next_index$4;
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$puts', '$boot_banner', '$dump', '$to_browser_hash', '$expose_to_browser!', '$attach_layout_bridge!', '$attach_territory_bridge!', '$attach_cpu_bridge!', '$attach_game_state_bridge!', '$announce!']);
  ...
  (function($base, $parent_nesting) {
    ...
    var $nesting = [self].concat($parent_nesting), $Rubyfight_boot_banner$1, $Rubyfight_announce$excl$2, $Rubyfight_expose_to_browser$excl$3, $Rubyfight_attach_territory_bridge$excl$4, $Rubyfight_attach_layout_bridge$excl$5, $Rubyfight_attach_cpu_bridge$excl$6, $Rubyfight_attach_game_state_bridge$excl$7;
    ...
    Opal.defs(self, '$attach_game_state_bridge!', $Rubyfight_attach_game_state_bridge$excl$7 = function() {
      var self = this, g = nil;
    ...
    ;
    }, $Rubyfight_attach_game_state_bridge$excl$7.$$arity = 0);
  })($nesting[0], $nesting);
