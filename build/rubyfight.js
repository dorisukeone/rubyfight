...
Opal.modules["rubyfight/game_state"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      var $nesting = [self].concat($parent_nesting), $GameState_tick_playing$1, $GameState_can_advance_from_result$ques$2, $GameState_menu_prev_index$3, $GameState_menu_next_index$4, $GameState_title_confirm_action$5;
      ...
      Opal.defs(self, '$menu_prev_index', $GameState_menu_prev_index$3 = function $$menu_prev_index(index, menu_size) {
        var self = this;

        return $rb_minus($rb_plus(index, menu_size), 1)['$%'](menu_size)
      }, $GameState_menu_prev_index$3.$$arity = 2);
      Opal.defs(self, '$menu_next_index', $GameState_menu_next_index$4 = function $$menu_next_index(index, menu_size) {
        var self = this;

        return $rb_plus(index, 1)['$%'](menu_size)
      }, $GameState_menu_next_index$4.$$arity = 2);
      Opal.defs(self, '$title_confirm_action', $GameState_title_confirm_action$5 = function $$title_confirm_action(menu_index) {
        var self = this, $case = nil;
      ...
      }, $GameState_title_confirm_action$5.$$arity = 1);
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$puts', '$boot_banner', '$dump', '$to_browser_hash', '$expose_to_browser!', '$attach_layout_bridge!', '$attach_territory_bridge!', '$attach_cpu_bridge!', '$attach_movement_bridge!', '$attach_game_state_bridge!', '$announce!']);
  ...
  (function($base, $parent_nesting) {
    ...
    Opal.defs(self, '$attach_movement_bridge!', $Rubyfight_attach_movement_bridge$excl$7 = function() {
      var self = this, m = nil;
    ...
    ;
    }, $Rubyfight_attach_movement_bridge$excl$7.$$arity = 0);
    Opal.defs(self, '$attach_game_state_bridge!', $Rubyfight_attach_game_state_bridge$excl$8 = function() {
      var self = this, g = nil;
    ...
    ;
    }, $Rubyfight_attach_game_state_bridge$excl$8.$$arity = 0);
  })($nesting[0], $nesting);
