...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$puts', '$boot_banner', '$dump', '$to_browser_hash', '$expose_to_browser!', '$attach_layout_bridge!', '$attach_territory_bridge!', '$attach_cpu_bridge!', '$announce!']);
  ...
  (function($base, $parent_nesting) {
    ...
    var $nesting = [self].concat($parent_nesting), $Rubyfight_boot_banner$1, $Rubyfight_announce$excl$2, $Rubyfight_expose_to_browser$excl$3, $Rubyfight_attach_territory_bridge$excl$4, $Rubyfight_attach_layout_bridge$excl$5, $Rubyfight_attach_cpu_bridge$excl$6;
