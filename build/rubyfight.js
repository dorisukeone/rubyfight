  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      Opal.defs(self, '$blink_500ms_primary?', $GameState_blink_500ms_primary$ques$3 = function(now_ms) {
        ...
        return $rb_divide(now_ms, 500).$floor()['$%'](2)['$=='](0)
...
Opal.modules["rubyfight/movement"] = function(Opal) {
  ...
  Opal.add_stubs(['$to_browser_hash', '$to_f', '$[]', '$<=', '$*', '$speed_for_time_remaining', '$<', '$/', '$+', '$-', '$>', '$==', '$%', '$floor']);
  return (function($base, $parent_nesting) {
    var self = $module($base, 'Rubyfight');
    ...
    (function($base, $parent_nesting) {
      ...
      Opal.defs(self, '$rush_hud_blink_primary?', $Movement_rush_hud_blink_primary$ques$5 = function(time_remaining, now_ms) {
        ...
        if ($truthy($rb_gt(time_remaining, c['$[]']("RUSH_TIME").$to_f()))) {
          return false};
        return $rb_divide(now_ms, 100).$floor()['$%'](2)['$=='](0);
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require', '$puts', '$boot_banner', '$dump', '$to_browser_hash', '$grid_rows', '$grid_cols', '$expose_to_browser!', '$attach_layout_bridge!', '$attach_territory_bridge!', '$attach_cpu_bridge!', '$attach_movement_bridge!', '$attach_match_bridge!', '$attach_session_bridge!', '$attach_game_state_bridge!', '$announce!']);
  ...
  (function($base, $parent_nesting) {
    ...
    Opal.defs(self, '$attach_match_bridge!', $Rubyfight_attach_match_bridge$excl$7 = function() {
    ...
    ;
    }, $Rubyfight_attach_match_bridge$excl$7.$$arity = 0);
    Opal.defs(self, '$attach_session_bridge!', $Rubyfight_attach_session_bridge$excl$8 = function() {
    ...
    ;
    }, $Rubyfight_attach_session_bridge$excl$8.$$arity = 0);
    Opal.defs(self, '$attach_movement_bridge!', $Rubyfight_attach_movement_bridge$excl$9 = function() {
      var self = this, m = nil;
    ...
    ;
    }, $Rubyfight_attach_movement_bridge$excl$9.$$arity = 0);
    Opal.defs(self, '$attach_game_state_bridge!', $Rubyfight_attach_game_state_bridge$excl$10 = function() {
      var self = this, g = nil;
    ...
    ;
    }, $Rubyfight_attach_game_state_bridge$excl$10.$$arity = 0);
  })($nesting[0], $nesting);
