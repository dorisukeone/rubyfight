...
Opal.modules["rubyfight/game_state"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      Opal.const_set($nesting[0], 'COUNTDOWN', "COUNTDOWN");
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      Opal.defs(self, '$to_browser_hash', $UiLayout_to_browser_hash$1 = function $$to_browser_hash() {
        ...
        return $hash2(["title"], {"title": $hash2(["logoCenterX", "juggingY", "mainTitleY", "subTerritoryY", "menu", "mascotLeft", "mascotRight", "mascotPixel", "footerControlsY", "footerFullscreenY", "parts"], {"logoCenterX": 480, "juggingY": 44, "mainTitleY": 126, "subTerritoryY": 216, "menu": $hash2(["y"], {"y": 292}), "mascotLeft": $hash2(["x", "y"], {"x": 280, "y": 404}), "mascotRight": $hash2(["x", "y"], {"x": 680, "y": 404}), "mascotPixel": 3, "footerControlsY": 458, "footerFullscreenY": 478, "parts": $hash2(["background", "logo", "charLeft", "charRight"], {"background": $hash2(["x", "y", "w", "h", "fit"], {"x": 0, "y": 0, "w": 960, "h": 540, "fit": "cover"}), "logo": $hash2(["x", "y", "w", "h", "fit"], {"x": 136, "y": 32, "w": 688, "h": 252, "fit": "contain"}), "charLeft": $hash2(["x", "y", "w", "h", "fit"], {"x": 190, "y": 281, "w": 180, "h": 180, "fit": "contain"}), "charRight": $hash2(["x", "y", "w", "h", "fit"], {"x": 596, "y": 281, "w": 180, "h": 180, "fit": "contain"})})})})
